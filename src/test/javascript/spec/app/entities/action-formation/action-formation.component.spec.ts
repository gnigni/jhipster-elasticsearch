...
import { ActionFormationComponent } from 'app/entities/action-formation/action-formation.component';
...
describe('Component Tests', () => {
    describe('ActionFormation Management Component', () => {
        let comp: ActionFormationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ActionFormationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.actionFormations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
